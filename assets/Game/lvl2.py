...
for i in range(3):
    mono = Macaco(16,16,"Bueno"+str(i),raza="missinglink")
    mono.Afiliacion=1
...
for i in range(2):
    mono = Macaco(16,16,"Malo"+str(i),raza="missinglink")
    mono.Afiliacion=2
...
def Init():
    SoundPlayer.pooling(ASSETS_DIR+"sounds/levels/level2.ogg",0.2)
